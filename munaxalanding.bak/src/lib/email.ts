...
/**
 * Sends the visitor-facing welcome / acknowledgment email, confirming receipt of their
 * inquiry and summarizing what they submitted.
 */
export async function sendAcknowledgmentEmail(data: InquiryEmailData): Promise<void> {
  ...
  const text = [
    ...
    'We have received your message and a member of our team will get back to you within one ' +
      'business day to schedule a demo and answer any questions.',
    '',
