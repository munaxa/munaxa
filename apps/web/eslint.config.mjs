...
/**
 * Munaxa Corporate ESLint (flat config). Fully self-contained — TypeScript
...
export default tseslint.config(
  ...
  },
  {
    ...
    // border-border, …). Tokens live in @munaxa/tokens + globals.css.
    files: ['src/**/*.{ts,tsx}'],
    rules: {
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'No hardcoded hex colors — use design-system token classes (e.g. text-coral, bg-card, border-border). Tokens: @munaxa/tokens + globals.css.',
        },
        {
          selector:
