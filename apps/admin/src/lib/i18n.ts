import type { Locale } from '@munaxa/domain';
import { DEFAULT_LOCALE, SUPPORTED_LOCALES } from '@munaxa/domain';
 ...
 */
export { Locale, DEFAULT_LOCALE, SUPPORTED_LOCALES, directionForLocale } from '@munaxa/domain';
