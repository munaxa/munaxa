...
export default [
  ...
  },
  {
    ...
    // Tailwind palette colors. Tokens: @munaxa/design-tokens (css/theme.oklch.css) + globals.css,
    ...
    rules: {
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'No hardcoded hex colors — use design-system token classes (e.g. text-coral, bg-card, border-border). Tokens: @munaxa/design-tokens (css/theme.oklch.css) + globals.css.',
        },
        {
          selector:
        ...
        },
        {
          ...
          message:
            'No raw Tailwind palette colors — use design-system token/semantic classes (bg-primary, text-muted-foreground, bg-success, text-warning, …). Tokens: @munaxa/design-tokens (css/theme.oklch.css) + globals.css.',
        },
        {
          selector:
