...
/**
 * Munaxa design-system tokens (inlined from the Munaxa monorepo's shared Tailwind preset
 * so this app is fully standalone). Palette: violet primary, coral accent, aqua highlight,
 * on deep dark surfaces. Supports RTL/LTR via logical properties.
 */
const config: Config = {
  darkMode: ['class'],
  content: ['./src/**/*.{ts,tsx}'],
