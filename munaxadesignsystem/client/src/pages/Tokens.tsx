...
const radius = ["4px", "8px", "12px", "16px"];
      ...
      <div className="min-h-full bg-background">
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg text-foreground/70">
              The foundational design elements that make up the MUNAXA design system. These tokens ensure consistency and scalability across all applications.
            </p>
          </div>
        </section>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              The primary brand color is <strong>#7A3FFF</strong> (Deep Purple). Use this for primary actions, highlights, and key information.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {primaryColors.map((color) => (
                <div key={color.name} className="text-center">
                  ...
                  />
                  <p className="font-mono text-xs font-semibold text-foreground/70">{color.name}</p>
                  <p className="font-mono text-xs text-foreground/50">{color.value}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              The neutral palette forms the backbone of the design. Use these for backgrounds, borders, and text. <strong>Rule: 80% neutral, 15% primary, 5% semantic.</strong>
            </p>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              Use semantic colors for status indicators and feedback. These represent 5% of the color usage.
            </p>
              ...
              {semanticColors.map((color) => (
                <div key={color.name} className="bg-card border border-border rounded-lg p-6">
                  <div
                    ...
                    style={{ backgroundColor: color.value }}
                  />
                  <p className="font-semibold text-foreground mb-1">{color.name}</p>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              <strong>Primary Font:</strong> IBM Plex Sans Arabic (with fallback to Inter, system-ui, sans-serif). Use weight variation to create hierarchy.
            </p>
            
            <div className="space-y-6">
              {typography.map((type) => (
                <div key={type.name} className="bg-card border border-border rounded-lg p-6">
                  <div style={{ fontSize: type.size }} className="font-semibold mb-2">
                    {type.name}
                  </div>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              Consistent 4px base unit for all spacing. Use these values for padding, margins, and gaps.
            </p>
            
            <div className="space-y-4">
              {spacing.map((space) => (
                <div key={space} className="flex items-center gap-6">
                  <div className="w-24 text-sm font-mono font-semibold text-foreground/70">{space}</div>
                  <div
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              Preferred radius values for different components. Cards use 12px, buttons and inputs use 8px, modals use 16px.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {radius.map((r) => (
                <div key={r} className="bg-card border border-border rounded-lg p-6">
                  <div
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              <strong>Rule: Prefer borders over shadows.</strong> Use shadows sparingly for depth.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                />
                <p className="font-semibold text-foreground mb-1">Shadow Small</p>
                <p className="font-mono text-xs text-foreground/60">0 1px 2px rgba(0,0,0,.05)</p>
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                />
                <p className="font-semibold text-foreground mb-1">Shadow Medium</p>
                <p className="font-mono text-xs text-foreground/60">0 4px 12px rgba(0,0,0,.08)</p>
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                />
                <p className="font-semibold text-foreground mb-1">Shadow Large</p>
                <p className="font-mono text-xs text-foreground/60">0 10px 30px rgba(0,0,0,.10)</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-12 bg-card/50 border-t border-border">
          <div className="max-w-6xl mx-auto text-center text-foreground/60 text-sm">
            <p>All design tokens are implemented as CSS variables for easy theming and customization.</p>
          </div>
        </section>
      </div>
    </Layout>
