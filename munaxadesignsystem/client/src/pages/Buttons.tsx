...
import { ChevronRight, Download, LoaderCircle, Trash2, Plus } from "lucide-react";
      ...
      <div className="min-h-full bg-background">
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg text-foreground/70">
              Buttons are the primary call-to-action elements. They should be clear, accessible, and responsive to user interactions.
            </p>
          </div>
        </section>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              Use primary buttons for the main action on a page. Background: #7A3FFF, Hover: #652ED8
            </p>
            
            <div className="bg-card border border-border rounded-lg p-8">
              <div className="space-y-6">
                <div>
                  <p className="text-sm font-semibold text-foreground/70 mb-4">Default State</p>
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground/70 mb-4">With Icons</p>
                  <div className="flex flex-wrap gap-4">
                    <Button>
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground/70 mb-4">Disabled State</p>
                  <div className="flex flex-wrap gap-4">
                    <Button disabled>Disabled</Button>
                    <Button disabled size="lg">Large Disabled</Button>
                  </div>
                </div>

                <div>
                  <p className="text-sm font-semibold text-foreground/70 mb-4">Loading State</p>
                  <div className="flex flex-wrap gap-4">
                    <Button disabled>
                    <LoaderCircle className="me-2 size-4 animate-spin" aria-hidden />
                      Loading...
                    </Button>
                  </div>
                </div>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              Use secondary buttons for alternative actions. Background: White, Border: Gray-200
            </p>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              Use danger buttons for destructive actions like delete. Background: #EF4444, Color: White
            </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <Button variant="destructive" size="lg">Delete All</Button>
                  </div>
                </div>
        ...
        <section className="px-6 py-12 border-b border-border">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-foreground/70 mb-6">
              Use ghost buttons for tertiary actions or links that look like text.
            </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border">
                  <tr>
                    ...
                    <td className="py-3 px-4 font-mono text-foreground">40px (default)</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-4 font-mono text-foreground">14px (Body MD)</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-foreground/70">Font Weight</td>
                    <td className="py-3 px-4 font-mono text-foreground">600 (semibold)</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-foreground/70">Padding</td>
                    <td className="py-3 px-4 font-mono text-foreground">12px 16px</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-foreground/70">Transition</td>
                    <td className="py-3 px-4 font-mono text-foreground">150ms ease-out</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="px-6 py-12 bg-card/50 border-t border-border">
          <div className="max-w-6xl mx-auto text-center text-foreground/60 text-sm">
            <p>Buttons should provide clear visual feedback and be accessible via keyboard and screen readers.</p>
          </div>
        </section>
      </div>
    </Layout>
