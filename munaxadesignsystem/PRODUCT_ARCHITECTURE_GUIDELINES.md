...
Workspace model: WORKSPACE_ARCHITECTURE.md. Record workspaces: RECORD_PATTERNS.md. History and governance: TIMELINE_PATTERN.md and AUDIT_TRAIL_PATTERN.md. Relationships: RELATED_RECORDS_PATTERN.md and DOMAIN_RELATIONSHIPS.md. Navigation/search: ENTERPRISE_NAVIGATION.md and UNIVERSAL_SEARCH_PATTERN.md. Components: DOMAIN_ARCHITECTURE.md.
