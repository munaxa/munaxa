...
Apply capability + scope + record state from PERMISSION_ARCHITECTURE.md. APIs filter data before render and revalidate every mutation. Workspaces support full, read-only, partially authorized, approval-pending, and denied modes without revealing protected relationships.
