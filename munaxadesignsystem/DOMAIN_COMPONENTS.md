...
> The complete School Domain Architecture platform is documented in DOMAIN_ARCHITECTURE.md and implemented under client/src/domain-components. This document remains the Product Architecture domain catalog for backward compatibility.
