...
## 3. New Composition Primitives (added to `@munaxa/ui`)
...
**Verification:** `@munaxa/ui` build · admin `typecheck` · admin `build` (36/36) — all green.
...
**Awaiting approval to begin Phase 5 (Domain Component Migration)** — building StudentCard/StudentTable, InvoiceTable/BalanceCard/AgingCard/FeeStatusCard, AttendanceStatusBadge/AttendanceCard, ReportCard/ReportFilterBar, etc. into `@munaxa/ui` and applying them, which directly closes most of the 🟡 pages above.
