...
Prisma + PostgreSQL with **RLS-enforced multi-tenancy** · shared packages (`@munaxa/domain`, `@munaxa/ui`, `@munaxa/i18n`).
...
- Reuse `Card/Table/Field/Select/Badge/EntityPicker/EmptyState`; i18n keys in `@munaxa/i18n` (En/Ar, RTL-safe).
