/**
 * Munaxa typography tokens. Font families, sizes, weights and line-heights.
 * Latin display/body faces lack Arabic glyphs, so an Arabic fallback family is provided
 * for RTL locales.
 */
