 ...
 * hex colors — use token classes / @axa/design-system/tokens).
 */
export default tseslint.config(
  ...
  },
  {
    ...
    // text-foreground, …) whose values come from @axa/design-system/tokens.
    files: ['src/**/*.{ts,tsx}'],
    ignores: ['src/seed/**'],
    rules: {
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'No hardcoded hex colors — use token classes (bg-primary, text-foreground, …) or @axa/design-system/tokens.',
        },
        {
          selector:
