...
> | Colour — the Munaxa palette | [`platform/themes/munaxa/palette.css`](../../../platform/themes/munaxa/palette.css) |
...
[`platform/assets/munaxa/`](../../../platform/assets/munaxa), which is the source for any new
...
- On screen, never hardcode the brand hex. Use `bg-primary` / `text-primary`, which follow the
  ...
  [`platform/themes/munaxa/brand.ts`](../../../platform/themes/munaxa/brand.ts).
