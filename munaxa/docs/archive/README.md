...
| Document | Subject |
| --- | --- |
| [design-system-monorepo-refactor.md](./design-system-monorepo-refactor.md) | The refactor that produced `@munaxa/design-tokens`, `@munaxa/icons` and `@munaxa/ui` — later extracted into `@axa/platform` |
