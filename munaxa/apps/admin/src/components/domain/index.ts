/**
 * Domain components: small, app-specific compositions over the @axa/design-system primitives
 * (e.g. status → toned Badge). They depend on app data types / enums, so they live in
 * the app rather than the generic @axa/design-system package. Each owns the single source of
