/**
 * Role-based access control — vendored from @munaxa/domain (roles, the permission
...
export const DEFAULT_ROLE_PERMISSIONS: Record<RoleKey, Permission[] | '*'> = {
  SchoolAdmin: '*',
  Principal: [
    P.CARD_MANAGE, P.CARD_READ, P.PRESENCE_READ, P.TRANSPORT_READ, P.ATTENDANCE_CONFIGURE,
    P.SCHOOL_MANAGE, P.CAMPUS_MANAGE, P.ACADEMICYEAR_MANAGE, P.GRADE_MANAGE, P.SECTION_MANAGE,
    P.CLASSROOM_MANAGE, P.TIMETABLE_READ, P.ATTENDANCE_READ, P.HOMEWORK_READ, P.BEHAVIOR_MANAGE,
    P.BEHAVIOR_READ, P.GRADE_READ, P.ANNOUNCEMENT_MANAGE, P.NOTIFICATION_SEND, P.LEAVE_APPROVE,
    P.REPORT_READ, P.REPORT_EXPORT, P.AUDIT_READ, P.FINANCE_READ, P.RESOURCE_READ, P.RESOURCE_MANAGE,
    P.ACHIEVEMENT_MANAGE, P.BUS_READ, P.LIBRARY_READ, P.INVENTORY_READ, P.CLINIC_READ,
    P.STUDENT_MANAGE, P.TEACHER_MANAGE, P.EMPLOYEE_MANAGE,
  ],
  Registrar: [
    P.STUDENT_MANAGE, P.PARENT_MANAGE, P.DOCUMENT_MANAGE, P.REPORT_READ, P.ATTENDANCE_READ,
    P.TIMETABLE_READ, P.ANNOUNCEMENT_READ, P.GRADE_READ,
  ],
  FinanceOfficer: [
    P.FINANCE_MANAGE, P.FINANCE_READ, P.FINANCE_EXPORT, P.TRANSACTION_CREATE, P.RECEIPT_UPLOAD,
    P.REPORT_READ, P.REPORT_EXPORT, P.AUDIT_READ, P.STUDENT_MANAGE,
  ],
  Teacher: [
    P.CARD_READ, P.PRESENCE_CREATE, P.PRESENCE_READ, P.TIMETABLE_READ, P.ATTENDANCE_CREATE,
    P.ATTENDANCE_READ, P.HOMEWORK_MANAGE, P.HOMEWORK_READ, P.BEHAVIOR_MANAGE, P.BEHAVIOR_READ,
    P.GRADE_IMPORT, P.GRADE_READ, P.ANNOUNCEMENT_READ, P.NOTIFICATION_SEND, P.REPORT_READ,
    P.RESOURCE_READ, P.RESOURCE_MANAGE, P.ACHIEVEMENT_MANAGE,
  ],
  Parent: [
    P.PRESENCE_READ, P.TRANSPORT_READ, P.ATTENDANCE_READ, P.HOMEWORK_READ, P.BEHAVIOR_READ,
    P.GRADE_READ, P.TIMETABLE_READ, P.ANNOUNCEMENT_READ, P.RECEIPT_UPLOAD, P.FINANCE_READ,
    P.LEAVE_REQUEST, P.PTM_BOOK, P.DOCUMENT_MANAGE, P.RESOURCE_READ, P.ACHIEVEMENT_READ,
    P.GAMIFICATION_READ,
  ],
  Student: [
    P.ATTENDANCE_READ, P.HOMEWORK_READ, P.BEHAVIOR_READ, P.GRADE_READ, P.TIMETABLE_READ,
    P.ANNOUNCEMENT_READ, P.RESOURCE_READ, P.ACHIEVEMENT_READ, P.GAMIFICATION_READ,
  ],
  BusSupervisor: [
    P.TRANSPORT_CREATE, P.TRANSPORT_READ, P.CARD_READ, P.BUS_READ, P.PRESENCE_READ,
  ],
};
...
export const PERSONAS: Persona[] = [
  {
    id: 'owner', role: 'SchoolAdmin',
    nameEn: 'School Owner', nameAr: 'مالك المدرسة', titleEn: 'Full administrative control', titleAr: 'تحكم إداري كامل',
    displayName: 'Rania Haddad', home: '/dashboard',
  ...
  },
  {
    ...
    nameEn: 'Principal', nameAr: 'المدير', titleEn: 'Academic leadership', titleAr: 'القيادة الأكاديمية',
    displayName: 'Dr. Samir Khoury', home: '/dashboard',
  ...
  {
    id: 'registrar', role: 'Registrar',
    nameEn: 'Registrar', nameAr: 'المسجل', titleEn: 'Admissions & records', titleAr: 'القبول والسجلات',
    displayName: 'Lina Aqel', home: '/students',
    blurbEn: 'Run admissions and manage the student & parent records.',
    blurbAr: 'إدارة القبول وسجلات الطلاب وأولياء الأمور.',
  },
  {
    id: 'finance', role: 'FinanceOfficer',
    nameEn: 'Finance Manager', nameAr: 'مدير المالية', titleEn: 'Billing & collections', titleAr: 'الفوترة والتحصيل',
    displayName: 'Omar Nseirat', home: '/finance',
  ...
  },
  {
    ...
    nameEn: 'Teacher', nameAr: 'المعلم', titleEn: 'Classroom & grading', titleAr: 'الصف والتقييم',
    displayName: 'Hala Mansour', home: '/portal/teacher',
  ...
  },
  {
    ...
    nameEn: 'Parent', nameAr: 'ولي الأمر', titleEn: 'Family portal', titleAr: 'بوابة الأسرة',
    displayName: 'Khaled Suleiman', home: '/portal/parent',
  ...
  },
  {
    ...
    nameEn: 'Student', nameAr: 'الطالب', titleEn: 'Student portal', titleAr: 'بوابة الطالب',
    displayName: 'Yousef Suleiman', home: '/portal/student',
    blurbEn: 'Timetable, homework, grades and achievements at a glance.',
    blurbAr: 'الجدول والواجبات والدرجات والإنجازات بنظرة واحدة.',
  },
  {
    id: 'bus', role: 'BusSupervisor',
    nameEn: 'Bus Supervisor', nameAr: 'مشرف الباص', titleEn: 'Transport & boarding', titleAr: 'النقل والصعود',
    displayName: 'Faisal Odeh', home: '/transport',
