...
export function Logo({
  ...
  return (
    <>
      <Image src={`/${base}-light.png`} {...common} className={cn('object-contain dark:hidden', className)} />
      <Image src={`/${base}-dark.png`} {...common} className={cn('hidden object-contain dark:block', className)} />
    </>
  );
}
